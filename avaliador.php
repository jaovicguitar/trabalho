...
<div class="container">
  ...
  <div class=" col-md-12 logo">
    ...
    <div class="col-md-12">
        <form class="texto" action="cad-avaliador.php" method="POST">
                ...
                <div class="form-group">
                  <label >Contato</label>
                  <input type="text" class="form-control col-md-5" id="contato" name="contato" placeholder="Digite o escritorio" required/>
                </div>
                <div class="form-group">
                    <label >Escritório</label>
                    <input type="text" class="form-control col-md-5" id="escritorio" name="escritorio" placeholder="Digite o gerente" required/>
                  </div>
