...
$query = sprintf("SELECT id,nome, contato , escritorio FROM avaliador");
// executa a query
...
<div class="col-md-12 logo">
  <marquee scrollDelay=50><h1><b>Consulta de avaliador</b> </h1></marquee>
</div>
<br/><br/>
...
?>
             ...
             <tr>
                  ...
                  <th class="cor"><?= $linha['nome']   ?></th>
                  <td class="cor"><?= $linha['contato']   ?></td>
                  <td class="cor"><?= $linha['escritorio']  ?></td>
                  <td><a href="excluir-avaliador.php?id=<?=$linha['id']?>" type="submit" class="btn btn-danger"> Excluir </a></td>
                  <td><a href="editaa.php?id=<?=$linha['id']?>" type="submit" class="btn btn-warning"> Editar </a></td>
