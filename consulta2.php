...
$query = sprintf("SELECT id,nome, escritorio , gerente FROM projeto");
// executa a query
...
?>
             ...
             <tr>
                  ...
                  <td class="cor"><?= $linha['gerente']  ?></td>
                  <td><a href="excluirp.php?id=<?=$linha['id']?>" type="submit" class="btn btn-danger"> Excluir </a></td>
                  <td><a href="editap.php?id=<?=$linha['id']?>" type="submit" class="btn btn-warning"> Editar </a></td>
