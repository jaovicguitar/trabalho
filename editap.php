...
$query = sprintf("SELECT nome, escritorio, gerente FROM projeto WHERE id='$id'");
// executa a query
...
<div class="container">
  ...
  <div class=" col-md-12 logo">
    ...
    <div class="col-md-12">
        <form class="texto" action="editar-conecp.php" method="POST">
                ...
                <div class="form-group">
                    <label >Gerente</label>
                    <input type="text" class="form-control col-md-5" id="gerente" name="gerente" placeholder="Digite o gerente" value="<?= $linha['gerente']   ?>" required/>
                  </div>

              <center> <button type="submit" class="btn btn-primary">Editar</button>
                <a class="btn btn-warning"  href="consulta2.php" role="button" type="submit">Voltar</a>
              </center> 
              </form>
